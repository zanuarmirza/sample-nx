...
import { ResponseData } from '@client-app/interfaces/common';

// REVIEW should be renamed as error handler instead useResponseHandler
// because most of the code referred as eror handler
